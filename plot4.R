...
plot(Global_power$DateTime,Global_power$Global_active_power, type="l", ylab="Global Active Power (kilowatts)",xlab="")


plot(Global_power$DateTime,Global_power$Voltage,type="l",xlab="datetime",ylab="Voltage")


plot(Global_power$DateTime,Global_power$Sub_metering_1, type="l", ylab="Energy Sub metering",xlab="", col = "black")

points(Global_power$DateTime,Global_power$Sub_metering_2,type="l",col="Red")
points(Global_power$DateTime,Global_power$Sub_metering_3,type="l",col="Blue")
legend("topright",c("Sub_metering_1","Sub_metering_2","Sub_metering_3"),col=c("Black","Red","Blue"),lty=c(1,1,1),cex=0.5)


plot(Global_power$DateTime,Global_power$Global_reactive_power,type="l",xlab="datetime",ylab="Global_reactive_power")
